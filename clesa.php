<html>
    ...
    <form action="energia.php" method="post">
        <h1>Este script le ayudará a saber cuanto será el costo de su próximo recibo<br> de energía electrica,
        o le ayudará a responder la duda de porqué<br> tiene que pagar esa cantidad.<p></h1>
        <h2>Cada kw en casa cuesta: $ 0.194<br>
        Cada kw en negocio cuesta: $ 0.178<p></h2>

       <p><h2>Cantidad de kw: <input type=number step="any" name=k placeholder="No acepta letras"></h2></p>
